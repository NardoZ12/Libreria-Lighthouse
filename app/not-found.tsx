  ...
  return (
    <div className="min-h-[60vh] flex flex-col items-center justify-center px-4 text-center py-20">
      <div className="w-20 h-20 bg-[#0C1F3F] rounded-2xl flex items-center justify-center mx-auto mb-6">
        <BookOpen size={36} className="text-[#F97316]" />
      </div>
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        ...
        <Link
          href="/libros"
          className="inline-flex items-center gap-2 border-2 border-[#F97316] text-[#F97316] px-6 py-3 rounded-xl font-semibold hover:bg-[#F97316] hover:text-white transition-colors"
        >
          Explorar catálogo
        </Link>
      </div>
